 ...
 */
// OS-HOME / LOGIN
$route['os-admin'] = "os-admin/home/login";
// ECOMMERCE GROUP
$route['os-admin/publish'] = "os-admin/ecommerce/publish";
$route['os-admin/publish/(:num)'] = "os-admin/ecommerce/publish/index/$1";
$route['os-admin/removeSecondaryImage'] = "os-admin/ecommerce/publish/removeSecondaryImage";
$route['os-admin/products'] = "os-admin/ecommerce/products";
$route['os-admin/products/(:num)'] = "os-admin/ecommerce/products/index/$1";
$route['os-admin/productStatusChange'] = "os-admin/ecommerce/products/productStatusChange";
$route['os-admin/shopcategories'] = "os-admin/ecommerce/ShopCategories";
$route['os-admin/shopcategories/(:num)'] = "os-admin/ecommerce/ShopCategories/index/$1";
$route['os-admin/editshopcategorie'] = "os-admin/ecommerce/ShopCategories/editShopCategorie";
$route['os-admin/orders'] = "os-admin/ecommerce/orders";
$route['os-admin/orders/(:num)'] = "os-admin/ecommerce/orders/index/$1";
$route['os-admin/changeOrdersOrderStatus'] = "os-admin/ecommerce/orders/changeOrdersOrderStatus";
$route['os-admin/brands'] = "os-admin/ecommerce/brands";
$route['os-admin/changePosition'] = "os-admin/ecommerce/ShopCategories/changePosition";
$route['os-admin/discounts'] = "os-admin/ecommerce/discounts";
$route['os-admin/discounts/(:num)'] = "os-admin/ecommerce/discounts/index/$1";
// BLOG GROUP
$route['os-admin/blogpublish'] = "os-admin/blog/BlogPublish";
$route['os-admin/blogpublish/(:num)'] = "os-admin/blog/BlogPublish/index/$1";
$route['os-admin/blog'] = "os-admin/blog/blog";
$route['os-admin/blog/(:num)'] = "os-admin/blog/blog/index/$1";
// SETTINGS GROUP
$route['os-admin/settings'] = "os-admin/settings/settings";
$route['os-admin/styling'] = "os-admin/settings/styling";
$route['os-admin/templates'] = "os-admin/settings/templates";
$route['os-admin/titles'] = "os-admin/settings/titles";
$route['os-admin/pages'] = "os-admin/settings/pages";
$route['os-admin/emails'] = "os-admin/settings/emails";
$route['os-admin/emails/(:num)'] = "os-admin/settings/emails/index/$1";
$route['os-admin/history'] = "os-admin/settings/history";
$route['os-admin/history/(:num)'] = "os-admin/settings/history/index/$1";
// ADVANCED SETTINGS
$route['os-admin/languages'] = "os-admin/advanced_settings/languages";
$route['os-admin/filemanager'] = "os-admin/advanced_settings/filemanager";
$route['os-admin/os-adminusers'] = "os-admin/advanced_settings/os-adminusers";
// TEXTUAL PAGES
$route['os-admin/pageedit/(:any)'] = "os-admin/textual_pages/TextualPages/pageEdit/$1";
$route['os-admin/changePageStatus'] = "os-admin/textual_pages/TextualPages/changePageStatus";
// LOGOUT
$route['os-admin/logout'] = "os-admin/home/home/logout";
// os-admin pass change ajax
$route['os-admin/changePass'] = "os-admin/home/home/changePass";
$route['os-admin/uploadOthersImages'] = "os-admin/ecommerce/publish/do_upload_others_images";
$route['os-admin/loadOthersImages'] = "os-admin/ecommerce/publish/loadOthersImages";
...
/*
  ...
  | -------------------------------------------------------------------------
 */
$route['calculator'] = "modules/calculator.php";
