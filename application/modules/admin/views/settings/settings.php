...
<hr>    <div class="x_panel">
      <div class="x_content">
        ...
        <div class="col-xs-3">
          ...
          <ul class="nav nav-tabs tabs-left">
            <li class="active"><a href="#home" data-toggle="tab">Site Settings</a>
            </li>
            <li><a href="#profile" data-toggle="tab">Footer Settings</a>
            </li>
            <li><a href="#messages" data-toggle="tab">Contact Settings</a>
            </li>
            <li><a href="#settings" data-toggle="tab">Shop Settings</a>
            </li>
          </ul>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="tab-pane" id="profile">
            <div class="col-md-6">
                <div class="panel panel-success col-h">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="">
                            <div class="input-group">
                                <textarea class="form-control" name="footerCopyright" >
                                    <?= $footerCopyright ?>
                                </textarea>
            ...
            <div class="col-md-6">
                <div class="panel panel-success col-h">
                    <div class="panel-heading">Footer Contacts </div>
                    <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="panel panel-success col-h">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="">
                            <div class="input-group">
                                <textarea class="form-control" name="footerAboutUs">
                                <?= $footerAboutUs ?>
                                </textarea>  
                            </div>
                            <span class="input-group-btn">
                ...
                <div class="panel panel-success col-h">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                                    Update <i class="fa fa-save" aria-hidden="true"></i>
                                </button>
                            </div>
                        </form>
                    </div>
