<p>Here you can control which pages you want to display</p>
<hr>
<div class="row">
    <div class="col-sm-6 col-md-4">
        <a href="javascript:void(0);" data-toggle="modal" data-target="#addPage" class="btn btn-primary" style="margin-bottom:10px;">Add New Page</a>
        <?php if (!empty($pages)) {
            ?>
